...
try:
    ...
    gym = None
    print("Warning: gymnasium not found. MAMLAgent will not function correctly.")
...
try:
    ...
    nn = None
    optim = None
    print("Warning: torch not found. MAMLAgent will not function correctly.")

try:
    import numpy as np
except ImportError:
    np = None
    print("Warning: numpy not found. MAMLAgent will not function correctly.")
...
class DecentralizedMAMLFleet:
    ...
    def evaluate_fleet(self, num_eval_tasks_per_agent=10):
        if not torch:
            return {"overall_average_reward": 0.0, "agent_rewards": []}
