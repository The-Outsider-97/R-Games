"""Puluc AI initialization + move selection runtime.

Puluc is a traditional race-and-capture game played by the K'iche' / Q'eqchi'
(Kekchi) peoples of Guatemala. This module wires Puluc into the shared R-Games
multi-agent AI stack and persists match learning between sessions.
"""
